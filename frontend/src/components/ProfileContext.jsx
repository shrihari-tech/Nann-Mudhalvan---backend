...
export const ProfileProvider = ({ children }) => {
  ...
  const fetchProfile = async (userId) => {
    try {
      if (userId) {
        const response = await axios.get(`https://nann-mudhalvan-kgm.vercel.app/user/profile/${userId}`);
  ...
  const updateProfile = async (userId, updatedProfile) => {
    try {
      const response = await axios.put(`https://nann-mudhalvan-kgm.vercel.app/user/update-profile/${userId}`, updatedProfile);
